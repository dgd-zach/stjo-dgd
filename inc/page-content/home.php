...
<?php // The Your Generosity band: one synced pattern (inc/generosity-band.php); inline blocks only while it does not exist. ?>
<?php echo stjo_generosity_band_seed_markup(); ?>
