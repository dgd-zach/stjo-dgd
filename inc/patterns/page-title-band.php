...
<!-- wp:paragraph {"align":"center","textColor":"white","className":"is-style-eyebrow"} -->
<p class="has-text-align-center is-style-eyebrow has-white-color has-text-color">Main Section Eyebrow Text</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","level":1,"textColor":"white"} -->
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color">General Content Section</h1>
<!-- /wp:heading -->
