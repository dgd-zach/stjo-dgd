 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Two-Column Text + Accordion"},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:group {"className":"stjo-accordion"} -->
<div class="wp-block-group stjo-accordion"><!-- wp:details -->
<details class="wp-block-details"><summary>Lorem ipsum dolor sit amet</summary><!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
